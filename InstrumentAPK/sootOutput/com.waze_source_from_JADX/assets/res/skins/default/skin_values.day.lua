...
local Palette = {
	...
	street = rgb(0xd3d8cc),
	private = rgb(0xD8DCD0),
	trails4x4 = rgb(0xAAA087),
	...
	parking = rgb(0xd2dbce),
	parking_lots = rgb(0xF4F2E9),
	parking_lots_pins = rgb(0xCFDBE7),

	-- No-Auto ------------------------

	railroads = rgb(0x889999),
	ferry_stroke = rgb(0x45b0b4),

	pedestrian = rgb(0xd5d6bd),
	trails = rgb(0xCBC2AD),
	walkway = rgb(0xd5d6bd),

	-- Areas ------------------------

	cities = rgb(0xF9F8F4),
	stations = rgb(0xeae9e5),
	parks = rgb(0xc2ebb3),
	sea = rgb(0xc6e6e4),
	lakes = rgb(0xc6e6e4),
	rivers = rgb(0xd0e7e6),
...
Colors = {
	...
	ParkingLots = {
		light_fill = color.saturate(0.03,color.lighten(0.02,Palette.parking_lots)),
		strong_fill = Palette.parking_lots,		
	},


	ParkingLotsPins = {
		light_fill = color.saturate(0.03,color.lighten(0.02,Palette.parking_lots_pins)),
	...
	Cities = {
		...
		light_label = color.saturate(0.01,color.lighten(0.4,Palette.label_cities)),
	...
	Stations = {
		light_fill = color.saturate(0.03,color.lighten(0.03,Palette.stations)),
	...
	Parks = {
		light_fill = color.desaturate(0.11,color.lighten(0.02,Palette.parks)),
