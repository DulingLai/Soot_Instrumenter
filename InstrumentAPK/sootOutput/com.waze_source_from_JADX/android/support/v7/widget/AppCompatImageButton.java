...
public class AppCompatImageButton extends ImageButton implements TintableBackgroundView {
    ...
    public AppCompatImageButton(Context $r1) throws  {
        this($r1, null);
    }

    public AppCompatImageButton(Context $r1, AttributeSet $r2) throws  {
        this($r1, $r2, C0192R.attr.imageButtonStyle);
    }

    public AppCompatImageButton(Context $r1, AttributeSet $r2, int $i0) throws  {
