...
public class AppCompatMultiAutoCompleteTextView extends MultiAutoCompleteTextView implements TintableBackgroundView {
    ...
    public AppCompatMultiAutoCompleteTextView(Context $r1) throws  {
        this($r1, null);
    }

    public AppCompatMultiAutoCompleteTextView(Context $r1, AttributeSet $r2) throws  {
        this($r1, $r2, C0192R.attr.autoCompleteTextViewStyle);
    }

    public AppCompatMultiAutoCompleteTextView(Context $r1, AttributeSet $r2, int $i0) throws  {
