...
public class AppCompatEditText extends EditText implements TintableBackgroundView {
    ...
    public AppCompatEditText(Context $r1) throws  {
        this($r1, null);
    }

    public AppCompatEditText(Context $r1, AttributeSet $r2) throws  {
        this($r1, $r2, C0192R.attr.editTextStyle);
    }

    public AppCompatEditText(Context $r1, AttributeSet $r2, int $i0) throws  {
