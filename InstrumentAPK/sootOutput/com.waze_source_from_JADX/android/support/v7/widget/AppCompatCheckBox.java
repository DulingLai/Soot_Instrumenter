...
public class AppCompatCheckBox extends CheckBox implements TintableCompoundButton {
    ...
    public AppCompatCheckBox(Context $r1) throws  {
        this($r1, null);
    }

    public AppCompatCheckBox(Context $r1, AttributeSet $r2) throws  {
        this($r1, $r2, C0192R.attr.checkboxStyle);
    }

    public AppCompatCheckBox(Context $r1, AttributeSet $r2, int $i0) throws  {
