...
class AndroidResources {
    static final int[] styleable_AnimatedVectorDrawable = new int[]{16843161};
    static final int[] styleable_AnimatedVectorDrawableTarget = new int[]{16842755, 16843213};
    ...
    static final int[] styleable_VectorDrawableClipPath = new int[]{16842755, 16843781};
    static final int styleable_VectorDrawableClipPath_name = 0;
    static final int styleable_VectorDrawableClipPath_pathData = 1;
    static final int[] styleable_VectorDrawableGroup = new int[]{16842755, 16843189, 16843190, 16843556, 16843557, 16843558, 16843866, 16843867};
    ...
    static final int[] styleable_VectorDrawablePath = new int[]{16842755, 16843780, 16843781, 16843782, 16843783, 16843784, 16843785, 16843786, 16843787, 16843788, 16843789, 16843979, 16843980};
    ...
    static final int[] styleable_VectorDrawableTypeArray = new int[]{16842755, 16843041, 16843093, 16843097, 16843551, 16843754, 16843771, 16843778, 16843779};
