...
*/
    ...
    public SparseArrayCompat() throws  {
        this(10);
    }

    public SparseArrayCompat(int $i0) throws  {
        this.mGarbage = false;
        if ($i0 == 0) {
            this.mKeys = ContainerHelpers.EMPTY_INTS;
            this.mValues = ContainerHelpers.EMPTY_OBJECTS;
        } else {
            $i0 = ContainerHelpers.idealIntArraySize($i0);
    ...
    public SparseArrayCompat<E> clone() throws  {
        SparseArrayCompat $r1 = null;
        try {
            SparseArrayCompat $r3 = (SparseArrayCompat) super.clone();
            $r1 = $r3;
    ...
    public void append(@Signature({"(ITE;)V"}) int $i0, @Signature({"(ITE;)V"}) E $r1) throws  {
        if (this.mSize == 0 || $i0 > this.mKeys[this.mSize - 1]) {
            ...
            if ($i1 >= this.mKeys.length) {
                int $i2 = ContainerHelpers.idealIntArraySize($i1 + 1);
                int[] $r2 = new int[$i2];
    ...
    public String toString() throws  {
        ...
        for (int $i0 = 0; $i0 < this.mSize; $i0++) {
            ...
            $r1.append(keyAt($i0));
            $r1.append('=');
            SparseArrayCompat $r2 = valueAt($i0);
            if ($r2 != this) {
                $r1.append($r2);
            } else {
                $r1.append("(this Map)");
