...
public class FacebookShareActivity extends SimpleWebActivity implements UrlCallback {
    private MyWazeNativeManager myWazeNativeManager = MyWazeNativeManager.getInstance();

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setTitleText(C1283R.string.share_share_title);
    }

    public void onWebViewSize(int width, int height) {
        this.myWazeNativeManager.getFacebookShareUrl(this, width, height);
    }
