...
public class Authorization extends AbstractSafeParcelable {
    ...
    Authorization(int $i0, String $r1, String $r2, byte[] $r3) throws  {
        this.mVersion = $i0;
    ...
    public Authorization(String $r1, String $r2, byte[] $r3) throws  {
        this(1, $r1, $r2, $r3);
    }
    ...
    public boolean equals(Object $r1) throws  {
        ...
        if (!($r1 instanceof Authorization)) {
            return false;
        }
        Authorization $r2 = (Authorization) $r1;
    ...
    public void writeToParcel(Parcel $r1, int $i0) throws  {
        AuthorizationCreator.zza(this, $r1, $i0);
    }
}
