...
public class UpdateCredentialsWorkflowRequest extends AbstractSafeParcelable {
    ...
    public UpdateCredentialsWorkflowRequest() throws  {
        this.version = 3;
        this.options = new Bundle();
    }

    UpdateCredentialsWorkflowRequest(int $i0, String $r1, AppDescription $r2, Bundle $r3, Account $r4, AccountAuthenticatorResponse $r5) throws  {
        this.version = $i0;
        this.accountName = $r1;
    ...
    public UpdateCredentialsWorkflowRequest setAccount(Account $r1) throws  {
    ...
    @Deprecated
    public UpdateCredentialsWorkflowRequest setAccountName(@Deprecated String $r1) throws  {
        this.account = TextUtils.isEmpty($r1) ? null : new Account($r1, "com.google");
        this.accountName = $r1;
        return this;
    }

    public UpdateCredentialsWorkflowRequest setAmResponse(AccountAuthenticatorResponse $r1) throws  {
        this.amResponse = $r1;
        return this;
    }

    public UpdateCredentialsWorkflowRequest setCallingAppDescription(AppDescription $r1) throws  {
        this.callingAppDescription = $r1;
        return this;
    }

    public UpdateCredentialsWorkflowRequest setOptions(Bundle $r1) throws  {
        this.options.clear();
        if ($r1 == null) {
            return this;
        }
    ...
    public void writeToParcel(Parcel $r1, int $i0) throws  {
        UpdateCredentialsWorkflowRequestCreator.zza(this, $r1, $i0);
    }
}
