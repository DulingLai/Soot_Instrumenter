...
public class UpdateCredentialsWorkflowRequestCreator implements Creator<UpdateCredentialsWorkflowRequest> {
    ...
    static void zza(UpdateCredentialsWorkflowRequest $r0, Parcel $r1, int $i0) throws  {
        int $i1 = zzb.zzea($r1);
    ...
    public UpdateCredentialsWorkflowRequest createFromParcel(Parcel $r1) throws  {
        ...
        if ($r1.dataPosition() == $i0) {
            return new UpdateCredentialsWorkflowRequest($i1, $r6, $r5, $r3, $r4, $r2);
        }
        throw new zza.zza("Overread allowed size end=" + $i0, $r1);
    }

    public UpdateCredentialsWorkflowRequest[] newArray(int $i0) throws  {
        return new UpdateCredentialsWorkflowRequest[$i0];
    }
}
