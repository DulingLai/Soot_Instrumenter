...
public class zzag implements Creator<SkillsImpl> {
    static void zza(SkillsImpl $r0, Parcel $r1, int $i0) throws  {
        int $i1 = zzb.zzea($r1);
        Set $r2 = $r0.aOu;
    ...
    public SkillsImpl[] zzacg(int $i0) throws  {
        return new SkillsImpl[$i0];
    }

    public SkillsImpl zzto(Parcel $r1) throws  {
        String $r3 = null;
        int $i0 = zza.zzdz($r1);
        ...
        if ($r1.dataPosition() == $i0) {
            return new SkillsImpl($r2, $i1, $r4, $r3);
        }
