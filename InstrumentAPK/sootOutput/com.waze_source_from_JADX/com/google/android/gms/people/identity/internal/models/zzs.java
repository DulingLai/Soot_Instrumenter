...
public class zzs implements Creator<NicknamesImpl> {
    static void zza(NicknamesImpl $r0, Parcel $r1, int $i0) throws  {
        int $i1 = zzb.zzea($r1);
        Set $r2 = $r0.aOu;
    ...
    public NicknamesImpl[] zzabo(int $i0) throws  {
        return new NicknamesImpl[$i0];
    }

    public NicknamesImpl zztb(Parcel $r1) throws  {
        String $r2 = null;
        int $i0 = zza.zzdz($r1);
        ...
        if ($r1.dataPosition() == $i0) {
            return new NicknamesImpl($r3, $i1, $r5, $r4, $r2);
        }
