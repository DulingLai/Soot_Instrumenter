...
public class zzp implements Creator<MembershipsImpl> {
    static void zza(MembershipsImpl $r0, Parcel $r1, int $i0) throws  {
        int $i1 = zzb.zzea($r1);
        Set $r2 = $r0.aOu;
        ...
        if ($r2.contains(Integer.valueOf(3))) {
            zzb.zza($r1, 3, $r0.aPo, true);
        }
        if ($r2.contains(Integer.valueOf(4))) {
            zzb.zza($r1, 4, $r0.aPp, true);
        }
    ...
    public MembershipsImpl[] zzabl(int $i0) throws  {
        return new MembershipsImpl[$i0];
    }

    public MembershipsImpl zzsy(Parcel $r1) throws  {
        String $r2 = null;
        int $i0 = zza.zzdz($r1);
        ...
        if ($r1.dataPosition() == $i0) {
            return new MembershipsImpl($r3, $i1, $r6, $r5, $r4, $r2);
        }
