...
public class zzj implements Creator<EventsImpl> {
    static void zza(EventsImpl $r0, Parcel $r1, int $i0) throws  {
        int $i1 = zzb.zzea($r1);
        Set $r2 = $r0.aOu;
    ...
    public EventsImpl[] zzabe(int $i0) throws  {
        return new EventsImpl[$i0];
    }

    public EventsImpl zzss(Parcel $r1) throws  {
        String $r2 = null;
        int $i0 = zza.zzdz($r1);
        ...
        if ($r1.dataPosition() == $i0) {
            return new EventsImpl($r3, $i1, $r6, $r5, $r4, $r2);
        }
