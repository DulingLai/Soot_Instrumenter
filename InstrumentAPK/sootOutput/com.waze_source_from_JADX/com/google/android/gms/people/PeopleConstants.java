...
public class PeopleConstants {
    ...
    private PeopleConstants() throws  {
    }

    public static int booleanToTriState(Boolean $r0) throws  {
        return $r0 == null ? 0 : $r0.booleanValue() ? 2 : 1;
    }

    public static Boolean triStateToBoolean(int $i0) throws  {
        boolean $z0 = true;
        if ($i0 == 0) {
            return null;
        }
