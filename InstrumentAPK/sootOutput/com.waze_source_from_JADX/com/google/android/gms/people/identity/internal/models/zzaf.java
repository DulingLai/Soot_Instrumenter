...
public class zzaf implements Creator<RelationshipStatusesImpl> {
    static void zza(RelationshipStatusesImpl $r0, Parcel $r1, int $i0) throws  {
        int $i1 = zzb.zzea($r1);
        Set $r2 = $r0.aOu;
    ...
    public RelationshipStatusesImpl[] zzacf(int $i0) throws  {
        return new RelationshipStatusesImpl[$i0];
    }

    public RelationshipStatusesImpl zztn(Parcel $r1) throws  {
        String $r2 = null;
        int $i0 = zza.zzdz($r1);
        ...
        while ($r1.dataPosition() < $i0) {
            ...
            switch (zza.zziv($i2)) {
                case 1:
                    ...
                    break;
                case 2:
                    Parcelable $r8 = zza.zza($r1, $i2, MetadataImpl.CREATOR);
        ...
        if ($r1.dataPosition() == $i0) {
            return new RelationshipStatusesImpl($r3, $i1, $r5, $r4, $r2);
        }
