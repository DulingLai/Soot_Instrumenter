...
public class zzac implements Creator<ProfileOwnerStatsImpl> {
    static void zza(ProfileOwnerStatsImpl $r0, Parcel $r1, int i) throws  {
        i = zzb.zzea($r1);
        Set $r2 = $r0.aOu;
    ...
    public ProfileOwnerStatsImpl[] zzacc(int $i0) throws  {
        return new ProfileOwnerStatsImpl[$i0];
    }

    public ProfileOwnerStatsImpl zztk(Parcel $r1) throws  {
        long $l0 = 0;
        int $i1 = zza.zzdz($r1);
        ...
        if ($r1.dataPosition() == $i1) {
            return new ProfileOwnerStatsImpl($r2, $i2, $l3, $l0);
        }
