...
public class zzu implements Creator<OccupationsImpl> {
    static void zza(OccupationsImpl $r0, Parcel $r1, int $i0) throws  {
        int $i1 = zzb.zzea($r1);
        Set $r2 = $r0.aOu;
    ...
    public OccupationsImpl[] zzabq(int $i0) throws  {
        return new OccupationsImpl[$i0];
    }

    public OccupationsImpl zztd(Parcel $r1) throws  {
        String $r3 = null;
        int $i0 = zza.zzdz($r1);
        ...
        if ($r1.dataPosition() == $i0) {
            return new OccupationsImpl($r2, $i1, $r4, $r3);
        }
