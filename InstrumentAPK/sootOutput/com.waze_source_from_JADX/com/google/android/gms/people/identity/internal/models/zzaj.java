...
public class zzaj implements Creator<UrlsImpl> {
    static void zza(UrlsImpl $r0, Parcel $r1, int $i0) throws  {
        int $i1 = zzb.zzea($r1);
        Set $r2 = $r0.aOu;
    ...
    public UrlsImpl[] zzacj(int $i0) throws  {
        return new UrlsImpl[$i0];
    }

    public UrlsImpl zztr(Parcel $r1) throws  {
        String $r2 = null;
        int $i0 = zza.zzdz($r1);
        ...
        if ($r1.dataPosition() == $i0) {
            return new UrlsImpl($r3, $i1, $r6, $r5, $r4, $r2);
        }
