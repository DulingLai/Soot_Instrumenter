...
public class zzai implements Creator<TaglinesImpl> {
    static void zza(TaglinesImpl $r0, Parcel $r1, int $i0) throws  {
        int $i1 = zzb.zzea($r1);
        Set $r2 = $r0.aOu;
    ...
    public TaglinesImpl[] zzaci(int $i0) throws  {
        return new TaglinesImpl[$i0];
    }

    public TaglinesImpl zztq(Parcel $r1) throws  {
        String $r3 = null;
        int $i0 = zza.zzdz($r1);
        ...
        if ($r1.dataPosition() == $i0) {
            return new TaglinesImpl($r2, $i1, $r4, $r3);
        }
