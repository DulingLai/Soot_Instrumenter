...
public class zzd implements Creator<BraggingRightsImpl> {
    static void zza(BraggingRightsImpl $r0, Parcel $r1, int $i0) throws  {
        int $i1 = zzb.zzea($r1);
        Set $r2 = $r0.aOu;
    ...
    public BraggingRightsImpl[] zzaba(int $i0) throws  {
        return new BraggingRightsImpl[$i0];
    }

    public BraggingRightsImpl zzso(Parcel $r1) throws  {
        String $r3 = null;
        int $i0 = zza.zzdz($r1);
        ...
        if ($r1.dataPosition() == $i0) {
            return new BraggingRightsImpl($r2, $i1, $r4, $r3);
        }
