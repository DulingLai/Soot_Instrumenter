...
public class zzf implements Creator<CustomFieldsImpl> {
    static void zza(CustomFieldsImpl $r0, Parcel $r1, int i) throws  {
        i = zzb.zzea($r1);
        Set $r2 = $r0.aOu;
    ...
    public CustomFieldsImpl[] zzabc(int $i0) throws  {
        return new CustomFieldsImpl[$i0];
    }

    public CustomFieldsImpl zzsq(Parcel $r1) throws  {
        String $r3 = null;
        int $i0 = zza.zzdz($r1);
        ...
        if ($r1.dataPosition() == $i0) {
            return new CustomFieldsImpl($r2, $i1, $r4, $r3);
        }
