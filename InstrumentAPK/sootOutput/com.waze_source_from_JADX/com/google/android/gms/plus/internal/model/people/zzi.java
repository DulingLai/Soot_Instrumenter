...
public class zzi implements Creator<PlacesLivedEntity> {
    static void zza(PlacesLivedEntity $r0, Parcel $r1, int i) throws  {
        i = zzb.zzea($r1);
        Set $r2 = $r0.aOu;
    ...
    public PlacesLivedEntity[] zzaep(int $i0) throws  {
        return new PlacesLivedEntity[$i0];
    }

    public PlacesLivedEntity zzvm(Parcel $r1) throws  {
        boolean $z0 = false;
        int $i0 = zza.zzdz($r1);
        ...
        if ($r1.dataPosition() == $i0) {
            return new PlacesLivedEntity($r2, $i1, $z0, $r3);
        }
