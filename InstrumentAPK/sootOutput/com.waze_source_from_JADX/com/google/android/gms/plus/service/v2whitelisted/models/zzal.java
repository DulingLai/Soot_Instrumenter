...
public class zzal implements Creator<Nicknames> {
    static void zza(Nicknames $r0, Parcel $r1, int $i0) throws  {
        int $i1 = zzb.zzea($r1);
        Set $r2 = $r0.aOu;
    ...
    public Nicknames[] zzagc(int $i0) throws  {
        return new Nicknames[$i0];
    }

    public Nicknames zzwz(Parcel $r1) throws  {
        String $r2 = null;
        int $i0 = zza.zzdz($r1);
        ...
        if ($r1.dataPosition() == $i0) {
            return new Nicknames($r3, $i1, $r5, $r4, $r2);
        }
