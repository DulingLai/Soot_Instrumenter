...
public class zzk implements Creator<Abouts> {
    static void zza(Abouts $r0, Parcel $r1, int $i0) throws  {
        int $i1 = zzb.zzea($r1);
        Set $r2 = $r0.aOu;
    ...
    public Abouts[] zzafb(int $i0) throws  {
        return new Abouts[$i0];
    }

    public Abouts zzvy(Parcel $r1) throws  {
        String $r2 = null;
        int $i0 = zza.zzdz($r1);
        ...
        if ($r1.dataPosition() == $i0) {
            return new Abouts($r3, $i1, $r5, $r4, $r2);
        }
