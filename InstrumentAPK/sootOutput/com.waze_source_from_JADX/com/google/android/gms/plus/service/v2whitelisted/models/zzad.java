...
public class zzad implements Creator<Languages> {
    static void zza(Languages $r0, Parcel $r1, int $i0) throws  {
        int $i1 = zzb.zzea($r1);
        Set $r2 = $r0.aOu;
    ...
    public Languages[] zzafu(int $i0) throws  {
        return new Languages[$i0];
    }

    public Languages zzwr(Parcel $r1) throws  {
        String $r3 = null;
        int $i0 = zza.zzdz($r1);
        ...
        if ($r1.dataPosition() == $i0) {
            return new Languages($r2, $i1, $r4, $r3);
        }
