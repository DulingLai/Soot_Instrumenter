...
public class zzaw implements Creator<Urls> {
    static void zza(Urls $r0, Parcel $r1, int $i0) throws  {
        int $i1 = zzb.zzea($r1);
        Set $r2 = $r0.aOu;
    ...
    public Urls[] zzagn(int $i0) throws  {
        return new Urls[$i0];
    }

    public com.google.android.gms.plus.service.v2whitelisted.models.Person.Urls zzxk(android.os.Parcel r26) throws  {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:9:0x0054 in {5, 6, 7, 8, 10, 11, 12, 17, 19} preds:[]
...
*/
    ...
    L_0x00a6:
        ...
        throw r21;
    L_0x00d1:
        r24 = new com.google.android.gms.plus.service.v2whitelisted.models.Person$Urls;
        r0 = r24;
        r1 = r9;
        r2 = r10;
        r3 = r13;
        ...
        return r24;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.plus.service.v2whitelisted.models.zzaw.zzxk(android.os.Parcel):com.google.android.gms.plus.service.v2whitelisted.models.Person$Urls");
    }
}
