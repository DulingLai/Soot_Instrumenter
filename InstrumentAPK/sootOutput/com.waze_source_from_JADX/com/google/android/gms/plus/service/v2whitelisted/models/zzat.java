...
public class zzat implements Creator<Skills> {
    static void zza(Skills $r0, Parcel $r1, int $i0) throws  {
        int $i1 = zzb.zzea($r1);
        Set $r2 = $r0.aOu;
    ...
    public Skills[] zzagk(int $i0) throws  {
        return new Skills[$i0];
    }

    public Skills zzxh(Parcel $r1) throws  {
        String $r3 = null;
        int $i0 = zza.zzdz($r1);
