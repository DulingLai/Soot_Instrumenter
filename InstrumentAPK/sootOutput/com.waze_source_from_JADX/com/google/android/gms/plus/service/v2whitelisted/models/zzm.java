...
public class zzm implements Creator<Birthdays> {
    static void zza(Birthdays $r0, Parcel $r1, int $i0) throws  {
        int $i1 = zzb.zzea($r1);
        Set $r2 = $r0.aOu;
    ...
    public Birthdays[] zzafd(int $i0) throws  {
        return new Birthdays[$i0];
    }

    public Birthdays zzwa(Parcel $r1) throws  {
        Mergedpeoplemetadata $r3 = null;
        int $i0 = zza.zzdz($r1);
        ...
        while ($r1.dataPosition() < $i0) {
            ...
            switch (zza.zziv($i2)) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    $r3 = (Mergedpeoplemetadata) zza.zza($r1, $i2, Mergedpeoplemetadata.CREATOR);
        ...
        if ($r1.dataPosition() == $i0) {
            return new Birthdays($r2, $i1, $r4, $r3);
        }
