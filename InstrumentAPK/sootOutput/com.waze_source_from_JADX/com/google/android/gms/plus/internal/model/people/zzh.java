...
public class zzh implements Creator<OrganizationsEntity> {
    static void zza(OrganizationsEntity $r0, Parcel $r1, int i) throws  {
        i = zzb.zzea($r1);
        Set $r2 = $r0.aOu;
        ...
        if ($r2.contains(Integer.valueOf(2))) {
            zzb.zza($r1, 2, $r0.aPI, true);
        }
        if ($r2.contains(Integer.valueOf(3))) {
            zzb.zza($r1, 3, $r0.mDescription, true);
        }
        if ($r2.contains(Integer.valueOf(4))) {
            zzb.zza($r1, 4, $r0.aPK, true);
        }
        if ($r2.contains(Integer.valueOf(5))) {
            zzb.zza($r1, 5, $r0.aOw, true);
        }
        ...
        if ($r2.contains(Integer.valueOf(8))) {
            zzb.zza($r1, 8, $r0.aPM, true);
        }
        if ($r2.contains(Integer.valueOf(9))) {
            zzb.zza($r1, 9, $r0.Sm, true);
        }
    ...
    public OrganizationsEntity[] zzaeo(int $i0) throws  {
        return new OrganizationsEntity[$i0];
    }

    public com.google.android.gms.plus.internal.model.people.PersonEntity.OrganizationsEntity zzvl(android.os.Parcel r33) throws  {
...
*/
    ...
    L_0x0145:
        ...
        throw r28;
    L_0x0170:
        r31 = new com.google.android.gms.plus.internal.model.people.PersonEntity$OrganizationsEntity;
        r0 = r31;
        r1 = r15;
        r2 = r23;
        r3 = r22;
        ...
        return r31;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.plus.internal.model.people.zzh.zzvl(android.os.Parcel):com.google.android.gms.plus.internal.model.people.PersonEntity$OrganizationsEntity");
    }
}
