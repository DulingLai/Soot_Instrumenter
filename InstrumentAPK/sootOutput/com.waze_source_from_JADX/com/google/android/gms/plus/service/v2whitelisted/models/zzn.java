...
public class zzn implements Creator<BraggingRights> {
    static void zza(BraggingRights $r0, Parcel $r1, int $i0) throws  {
        int $i1 = zzb.zzea($r1);
        Set $r2 = $r0.aOu;
    ...
    public BraggingRights[] zzafe(int $i0) throws  {
        return new BraggingRights[$i0];
    }

    public BraggingRights zzwb(Parcel $r1) throws  {
        String $r3 = null;
        int $i0 = zza.zzdz($r1);
        ...
        if ($r1.dataPosition() == $i0) {
            return new BraggingRights($r2, $i1, $r4, $r3);
        }
