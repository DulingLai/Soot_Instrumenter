...
public class zzam implements Creator<Occupations> {
    static void zza(Occupations $r0, Parcel $r1, int $i0) throws  {
        int $i1 = zzb.zzea($r1);
        Set $r2 = $r0.aOu;
    ...
    public Occupations[] zzagd(int $i0) throws  {
        return new Occupations[$i0];
    }

    public Occupations zzxa(Parcel $r1) throws  {
        String $r3 = null;
        int $i0 = zza.zzdz($r1);
        ...
        if ($r1.dataPosition() == $i0) {
            return new Occupations($r2, $i1, $r4, $r3);
        }
