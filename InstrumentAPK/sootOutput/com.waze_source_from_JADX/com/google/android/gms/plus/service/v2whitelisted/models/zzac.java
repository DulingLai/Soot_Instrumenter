...
public class zzac implements Creator<Interests> {
    static void zza(Interests $r0, Parcel $r1, int $i0) throws  {
        int $i1 = zzb.zzea($r1);
        Set $r2 = $r0.aOu;
    ...
    public Interests[] zzaft(int $i0) throws  {
        return new Interests[$i0];
    }

    public Interests zzwq(Parcel $r1) throws  {
        String $r3 = null;
        int $i0 = zza.zzdz($r1);
        ...
        if ($r1.dataPosition() == $i0) {
            return new Interests($r2, $i1, $r4, $r3);
        }
