...
public enum zzag {
    ...
    ACCOUNT("account"),
    ACTIVITY(RecoveryParamConstants.VALUE_ACTIVITY),
    ACTIVATE("activate"),
    ...
    LOCALE("locale"),
    LOCATION(WLTypes.VEHICLEDATA_ATTRIBUTE_LOCATION),
    MALWARE_DISABLED("malware_disabled"),
    MAP("map"),
    MAX("max"),
    METRIC("metric"),
    MIN("min"),
    MODE(PlannedDriveAlternateFromActivity.MODE),
    NAME("name"),
    ...
    private zzag(@Signature({"(", "Ljava/lang/String;", ")V"}) String $r2) throws  {
        this.zzuk = $r2;
    }
