...
public class zzbf extends zzbp {
    ...
    private static volatile Long zzeb = null;

    public zzbf(zzax $r1, String $r2, String $r3, zza $r4, int $i0, int $i1) throws  {
    ...
    protected void zzct() throws IllegalAccessException, InvocationTargetException {
        if (zzeb == null) {
            synchronized (zzafc) {
                if (zzeb == null) {
                    zzeb = (Long) this.zzahh.invoke(null, new Object[0]);
                }
            }
        }
        synchronized (this.zzaha) {
            this.zzaha.zzeb = zzeb;
        }
    }
}
