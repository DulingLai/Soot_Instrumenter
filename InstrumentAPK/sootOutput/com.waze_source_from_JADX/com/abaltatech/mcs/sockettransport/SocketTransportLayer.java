...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find block by offset: 0x0024 in list [B:35:0x0063]
...
*/
        ...
        r17 = this;
    L_0x0000:
        r1 = 10;	 Catch:{ InterruptedException -> 0x006e }
    ...
    L_0x0010:
        r0 = r17;
        r6 = r0.m_clientSocket;
        r5 = r6.isClosed();	 Catch:{ IOException -> 0x0070 }
        if (r5 != 0) goto L_0x0024;
    L_0x001a:
        r0 = r17;	 Catch:{ IOException -> 0x0070 }
        r6 = r0.m_clientSocket;	 Catch:{ IOException -> 0x0070 }
        r5 = r6.isConnected();	 Catch:{ IOException -> 0x0070 }
        if (r5 != 0) goto L_0x004c;
    L_0x0024:
        r4 = 1;
        r0 = r17;
        r7 = r0.TAG;
        r8 = new java.lang.StringBuilder;	 Catch:{ IOException -> 0x0070 }
        r8.<init>();	 Catch:{ IOException -> 0x0070 }
        r9 = "Closed connection to ";	 Catch:{ IOException -> 0x0070 }
        r8 = r8.append(r9);	 Catch:{ IOException -> 0x0070 }
        r0 = r17;	 Catch:{ IOException -> 0x0070 }
        r6 = r0.m_clientSocket;	 Catch:{ IOException -> 0x0070 }
        r8 = r8.append(r6);	 Catch:{ IOException -> 0x0070 }
        r10 = r8.toString();	 Catch:{ IOException -> 0x0070 }
        com.abaltatech.mcs.logger.MCSLogger.log(r7, r10);	 Catch:{ IOException -> 0x0070 }
    L_0x0043:
        monitor-exit(r17);
    ...
    L_0x004c:
        r0 = r17;
        r11 = r0.m_input;
        r12 = r11.available();	 Catch:{ IOException -> 0x0070 }
        if (r12 <= 0) goto L_0x0043;
    L_0x0056:
        r13 = 1;
        r0 = r17;
        r0.m_isNotificationSent = r13;
        r3 = 1;
        r0 = r17;
        r5 = r0.m_isNotificationSent;
    ...
    L_0x002e:
        ...
        r8 = r7.toString();
        r10 = r6.toString();
        com.abaltatech.mcs.logger.MCSLogger.log(r8, r10);
        r11.closeConnection();
        goto L_0x0029;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.abaltatech.mcs.sockettransport.SocketTransportLayer.readData(byte[], int):int");
    }
