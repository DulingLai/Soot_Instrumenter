...
*/
    ...
    L_0x0008:
        r2 = r10.m_layer2;
    L_0x000a:
        r11 = com.abaltatech.mcs.common.MemoryPool.BufferSizeBig;
        r4 = "ConnectionLayer";	 Catch:{ MCSException -> 0x003c }
        r3 = com.abaltatech.mcs.common.MemoryPool.getMem(r11, r4);	 Catch:{ MCSException -> 0x003c }
    L_0x0012:
    ...
    L_0x0024:
        ...
        com.abaltatech.mcs.logger.MCSLogger.log(r4, r6);	 Catch:{ Exception -> 0x0024, Throwable -> 0x0063 }
        if (r3 == 0) goto L_0x006c;
    L_0x0030:
        r4 = "ConnectionLayer";
        com.abaltatech.mcs.common.MemoryPool.freeMem(r3, r4);
        return;
    L_0x0036:
        r1 = r10.m_layer2;
        goto L_0x0005;
    ...
    L_0x003c:
        ...
        r6 = r8.toString();
        r4 = "===> ConnectorLayer";
        com.abaltatech.mcs.logger.MCSLogger.log(r4, r6);
        goto L_0x0012;
    L_0x005b:
    ...
    public void setLayer(int $i0, IMCSDataLayer $r1) throws  {
        ...
        if ($i0 == 1) {
            ...
            this.m_layer2 = $r1;
            this.m_notification2 = new LayerNotification(1, $r1, this);
        }
    }
