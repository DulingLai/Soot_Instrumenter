...
*/
    ...
    L_0x0020:
        ...
        r4 = com.abaltatech.mcs.tcpip.TCPIPPacketPool.getPacket(r5);	 Catch:{ MCSException -> 0x004f }
    ...
    L_0x0046:
        ...
        com.abaltatech.mcs.tcpip.TCPIPPacketPool.freePacket(r4);	 Catch:{ MCSException -> 0x004f }
        return;
    L_0x004f:
        r10 = move-exception;
        r7 = r10.toString();
    ...
    L_0x007a:
        ...
        com.abaltatech.mcs.tcpip.TCPIPAddressPool.freeAddress(r14);	 Catch:{ MCSException -> 0x004f }
        com.abaltatech.mcs.tcpip.TCPIPAddressPool.freeAddress(r15);	 Catch:{ MCSException -> 0x004f }
    L_0x00a1:
        r0 = r17;	 Catch:{ MCSException -> 0x004f }
        r6 = r0.processPacket(r4);	 Catch:{ MCSException -> 0x004f }
    ...
    L_0x00cf:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.abaltatech.mcs.tcpip.TCPIPLayer.processIncommingData():void");
    }
    ...
    L_0x000e:
        r2 = "OUT IP PACKET";
        com.abaltatech.mcs.logger.MCSLogger.log(r2, r7);
    L_0x0013:
        r0.writeData(r5, r6);
        return;
    L_0x0017:
        ...
        throw r3;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.abaltatech.mcs.tcpip.TCPIPLayer.doWriteData(byte[], int, java.lang.String):void");
    }
}
