...
public class TCPIPAddressPool {
    ...
    private static com.abaltatech.mcs.tcpip.TCPIPAddress getAddress() throws com.abaltatech.mcs.common.MCSException {
        /*
        r0 = m_freeAddresses;
        monitor-enter(r0);
    ...
    L_0x001c:
        ...
        r6 = "- FREE ADDRESSES";
        com.abaltatech.mcs.logger.MCSLogger.log(r6, r7);	 Catch:{ Throwable -> 0x0045 }
    L_0x003a:
        monitor-exit(r0);	 Catch:{ Throwable -> 0x0045 }
        return r4;
    L_0x003c:
        monitor-exit(r0);	 Catch:{ Throwable -> 0x0045 }
        r8 = new com.abaltatech.mcs.common.MCSException;
    ...
    L_0x0045:
        ...
        throw r9;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.abaltatech.mcs.tcpip.TCPIPAddressPool.getAddress():com.abaltatech.mcs.tcpip.TCPIPAddress");
    }
