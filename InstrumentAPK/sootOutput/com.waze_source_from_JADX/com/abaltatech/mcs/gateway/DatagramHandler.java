...
public class DatagramHandler implements IDatagramHandlerNotification {
    ...
    public int OnStartDatagramListening(com.abaltatech.mcs.common.IMCSConnectionAddress r18, com.abaltatech.mcs.common.IDatagramReceiver r19) throws  {
        /*
        r17 = this;
        r2 = -1;
        monitor-enter(r17);
        r4 = r18;
        r4 = (com.abaltatech.mcs.tcpip.TCPIPAddress) r4;	 Catch:{ Throwable -> 0x0054 }
        r3 = r4;
        ...
        r9 = new com.abaltatech.mcs.gateway.DatagramHandler$DatagramConnection;
        r0 = r17;
        r1 = r19;
    ...
    L_0x0039:
        ...
        com.abaltatech.mcs.logger.MCSLogger.log(r15);	 Catch:{ Throwable -> 0x0054 }
        goto L_0x0036;
    L_0x0054:
        r16 = move-exception;
    L_0x0055:
    ...
    L_0x0059:
        ...
        goto L_0x0039;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.abaltatech.mcs.gateway.DatagramHandler.OnStartDatagramListening(com.abaltatech.mcs.common.IMCSConnectionAddress, com.abaltatech.mcs.common.IDatagramReceiver):int");
    }
