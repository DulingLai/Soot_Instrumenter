                ...
                try {
                    ...
                    while ($r7.hasNext()) {
                        ...
                        if ($r9.isAcceptable()) {
                            ...
                            SocketChannelTransportLayer $r1 = new SocketChannelTransportLayer($r12);
                            TCPIPAddress $r2 = new TCPIPAddress((InetSocketAddress) $r12.socket().getRemoteSocketAddress());
                            this.m_receiver.OnConnectionEstablished($r2, this.m_serverAddress, $r1);
                        }
                    }
                } catch (Exception e) {
                }
