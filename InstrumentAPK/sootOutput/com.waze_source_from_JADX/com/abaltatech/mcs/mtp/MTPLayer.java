...
import com.abaltatech.mcs.common.IMCSDataLayer.EWriteMode;
...
public class MTPLayer extends MCSMultiPointLayerBase implements IConnectionListener, IDatagramHandler, IDatagramReceiver, IResolveAddress {
    ...
    public int StartDatagramListening(com.abaltatech.mcs.common.IMCSConnectionAddress r28, com.abaltatech.mcs.common.IDatagramReceiver r29) throws  {
...
*/
    ...
    L_0x0007:
        ...
        r9 = 0;
        r0 = r28;
        r8 = com.abaltatech.mcs.mtp.MTPPacket.CreateStartDatagramListeningPacket(r7, r0, r9);
    ...
    L_0x00b9:
        return r4;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.abaltatech.mcs.mtp.MTPLayer.StartDatagramListening(com.abaltatech.mcs.common.IMCSConnectionAddress, com.abaltatech.mcs.common.IDatagramReceiver):int");
    }

    public void onDataReceived(com.abaltatech.mcs.common.IMCSDataLayer r20) throws  {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:63:0x0167 in {5, 11, 15, 16, 21, 28, 30, 33, 50, 53, 62, 64, 71, 74, 88, 97, 102, 104, 108} preds:[]
...
*/
        /*
        r19 = this;
        r2 = com.abaltatech.mcs.common.MemoryPool.BufferSizeBig;
        r4 = "MTPPacket";	 Catch:{ MCSException -> 0x0093 }
        r3 = com.abaltatech.mcs.common.MemoryPool.getMem(r2, r4);	 Catch:{ MCSException -> 0x0093 }
    L_0x0008:
        r0 = r19;
        r0 = r0.m_dataLayer;
        r20 = r0;
        if (r20 == 0) goto L_0x025d;	 Catch:{ MCSException -> 0x0093 }
    L_0x0010:
        r0 = r19;
        r0 = r0.m_dataLayer;
        r20 = r0;
        r2 = r3.length;	 Catch:{ MCSException -> 0x0093 }
        r0 = r20;	 Catch:{ MCSException -> 0x0093 }
        r5 = r0.readData(r3, r2);	 Catch:{ MCSException -> 0x0093 }
        r2 = r5;
        if (r5 <= 0) goto L_0x025d;	 Catch:{ MCSException -> 0x0093 }
    L_0x0020:
        r6 = new java.lang.StringBuilder;	 Catch:{ MCSException -> 0x0093 }
        r6.<init>();	 Catch:{ MCSException -> 0x0093 }
        r4 = "Received ";	 Catch:{ MCSException -> 0x0093 }
        r6 = r6.append(r4);	 Catch:{ MCSException -> 0x0093 }
        r6 = r6.append(r5);	 Catch:{ MCSException -> 0x0093 }
        r4 = " bytes.";	 Catch:{ MCSException -> 0x0093 }
        r6 = r6.append(r4);	 Catch:{ MCSException -> 0x0093 }
        r7 = r6.toString();	 Catch:{ MCSException -> 0x0093 }
        r0 = r19;	 Catch:{ MCSException -> 0x0093 }
        r0.dumpInfo(r7);	 Catch:{ MCSException -> 0x0093 }
        r0 = r19;
        r8 = r0.m_dumpInfo;
        if (r8 == 0) goto L_0x0048;	 Catch:{ MCSException -> 0x0093 }
    L_0x0044:
        r9 = 0;	 Catch:{ MCSException -> 0x0093 }
        com.abaltatech.mcs.utils.ByteUtils.dumpBuffer(r3, r9, r5);	 Catch:{ MCSException -> 0x0093 }
    L_0x0048:
        r5 = 0;
    L_0x0049:
    ...
    L_0x004b:
        ...
        r12 = r0.m_bufferSize;
        r11 = r11 - r12;
        if (r11 != 0) goto L_0x009e;	 Catch:{ MCSException -> 0x0093 }
    L_0x0057:
        r6 = new java.lang.StringBuilder;	 Catch:{ MCSException -> 0x0093 }
        r6.<init>();	 Catch:{ MCSException -> 0x0093 }
        r4 = "The MTP buffer is invalid. Discarding ";	 Catch:{ MCSException -> 0x0093 }
        r6 = r6.append(r4);	 Catch:{ MCSException -> 0x0093 }
        r0 = r19;
        r10 = r0.m_inBuffer;
        r11 = r10.length;	 Catch:{ MCSException -> 0x0093 }
        r6 = r6.append(r11);	 Catch:{ MCSException -> 0x0093 }
        r4 = " bytes";	 Catch:{ MCSException -> 0x0093 }
        r6 = r6.append(r4);	 Catch:{ MCSException -> 0x0093 }
        r7 = r6.toString();	 Catch:{ MCSException -> 0x0093 }
        r0 = r19;	 Catch:{ MCSException -> 0x0093 }
        ...
        if (r8 != 0) goto L_0x009e;	 Catch:{ MCSException -> 0x0093 }
    L_0x008d:
        r13 = new java.lang.AssertionError;	 Catch:{ MCSException -> 0x0093 }
        r13.<init>();	 Catch:{ MCSException -> 0x0093 }
        throw r13;
    L_0x0093:
        r14 = move-exception;
        r7 = r14.toString();
        r4 = "ERROR";
        com.abaltatech.mcs.logger.MCSLogger.log(r4, r7);
        return;
    L_0x009e:
        r11 = java.lang.Math.min(r11, r2);	 Catch:{ MCSException -> 0x0093 }
        r0 = r19;
        r10 = r0.m_inBuffer;
        r0 = r19;	 Catch:{ MCSException -> 0x0093 }
        r12 = r0.m_bufferSize;	 Catch:{ MCSException -> 0x0093 }
        java.lang.System.arraycopy(r3, r5, r10, r12, r11);	 Catch:{ MCSException -> 0x0093 }
        r2 = r2 - r11;
        r5 = r5 + r11;
        r0 = r19;
        r12 = r0.m_bufferSize;
    ...
    L_0x00b9:
        ...
        r0 = r19;
        r15 = r0.m_readPos;
        r12 = r12 - r15;	 Catch:{ MCSException -> 0x0093 }
        r11 = com.abaltatech.mcs.mtp.MTPPacket.AnalyzeBuffer(r10, r11, r12);	 Catch:{ MCSException -> 0x0093 }
    ...
    L_0x00d0:
        ...
        r0 = r0.m_readPos;
        r16 = r0;
        r15 = r15 - r0;	 Catch:{ MCSException -> 0x0093 }
        r17 = com.abaltatech.mcs.mtp.MTPPacket.ParsePacket(r10, r12, r15);	 Catch:{ MCSException -> 0x0093 }
        r0 = r19;
        r12 = r0.m_readPos;
        r12 = r12 + r11;
        r0 = r19;
    ...
    L_0x00f2:
        r6 = new java.lang.StringBuilder;	 Catch:{ MCSException -> 0x0093 }
        r6.<init>();	 Catch:{ MCSException -> 0x0093 }
        r4 = "The MTP packet is received (";	 Catch:{ MCSException -> 0x0093 }
        r6 = r6.append(r4);	 Catch:{ MCSException -> 0x0093 }
        r6 = r6.append(r11);	 Catch:{ MCSException -> 0x0093 }
        r4 = " bytes).";	 Catch:{ MCSException -> 0x0093 }
        r6 = r6.append(r4);	 Catch:{ MCSException -> 0x0093 }
        ...
        r0.dumpInfo(r7);	 Catch:{ MCSException -> 0x0093 }
        r0 = r19;	 Catch:{ MCSException -> 0x0093 }
        r1 = r17;	 Catch:{ MCSException -> 0x0093 }
        r0.Process(r1);	 Catch:{ MCSException -> 0x0093 }
        r0 = r17;	 Catch:{ MCSException -> 0x0093 }
        r0.ReleasePacket();	 Catch:{ MCSException -> 0x0093 }
    L_0x011c:
    ...
    L_0x0138:
        ...
        r0 = r19;
        r12 = r0.m_readPos;
        r12 = r15 - r12;	 Catch:{ MCSException -> 0x0093 }
        r9 = 0;	 Catch:{ MCSException -> 0x0093 }
        r0 = r18;	 Catch:{ MCSException -> 0x0093 }
        java.lang.System.arraycopy(r10, r11, r0, r9, r12);	 Catch:{ MCSException -> 0x0093 }
        r0 = r19;
        r11 = r0.m_bufferSize;
        r0 = r19;
        r12 = r0.m_readPos;
    ...
    L_0x017d:
        r6 = new java.lang.StringBuilder;	 Catch:{ MCSException -> 0x0093 }
        r6.<init>();	 Catch:{ MCSException -> 0x0093 }
        r4 = "Invalid MTP packet is received (";	 Catch:{ MCSException -> 0x0093 }
        r6 = r6.append(r4);	 Catch:{ MCSException -> 0x0093 }
        r6 = r6.append(r11);	 Catch:{ MCSException -> 0x0093 }
        r4 = " bytes). Data loss detected!";	 Catch:{ MCSException -> 0x0093 }
        r6 = r6.append(r4);	 Catch:{ MCSException -> 0x0093 }
        r7 = r6.toString();	 Catch:{ MCSException -> 0x0093 }
        r4 = "MTP";	 Catch:{ MCSException -> 0x0093 }
        com.abaltatech.mcs.logger.MCSLogger.log(r4, r7);	 Catch:{ MCSException -> 0x0093 }
        goto L_0x011c;
    L_0x019c:
    ...
    L_0x019e:
        r6 = new java.lang.StringBuilder;	 Catch:{ MCSException -> 0x0093 }
        r6.<init>();	 Catch:{ MCSException -> 0x0093 }
        r4 = "Incomplete MTP packet is received (";	 Catch:{ MCSException -> 0x0093 }
        r6 = r6.append(r4);	 Catch:{ MCSException -> 0x0093 }
        r6 = r6.append(r11);	 Catch:{ MCSException -> 0x0093 }
        r4 = " bytes).";	 Catch:{ MCSException -> 0x0093 }
        r6 = r6.append(r4);	 Catch:{ MCSException -> 0x0093 }
    ...
    L_0x01bd:
        r6 = new java.lang.StringBuilder;	 Catch:{ MCSException -> 0x0093 }
        r6.<init>();	 Catch:{ MCSException -> 0x0093 }
        r4 = "The MTP buffer does not contain valid MTP message... discarding ";	 Catch:{ MCSException -> 0x0093 }
        r6 = r6.append(r4);	 Catch:{ MCSException -> 0x0093 }
        r0 = r19;
        r12 = r0.m_bufferSize;
        r0 = r19;
        r15 = r0.m_readPos;
        r12 = r12 - r15;	 Catch:{ MCSException -> 0x0093 }
        r6 = r6.append(r12);	 Catch:{ MCSException -> 0x0093 }
        r4 = " bytes. Data loss detected!";	 Catch:{ MCSException -> 0x0093 }
        r6 = r6.append(r4);	 Catch:{ MCSException -> 0x0093 }
        r7 = r6.toString();	 Catch:{ MCSException -> 0x0093 }
        r4 = "MTP";	 Catch:{ MCSException -> 0x0093 }
    ...
    L_0x01ea:
        ...
        r16 = r0;
        r15 = r15 - r0;	 Catch:{ MCSException -> 0x0093 }
        com.abaltatech.mcs.utils.ByteUtils.dumpBuffer(r10, r12, r15);	 Catch:{ MCSException -> 0x0093 }
    L_0x0200:
        r0 = r19;	 Catch:{ MCSException -> 0x0093 }
        r12 = r0.m_readPos;	 Catch:{ MCSException -> 0x0093 }
        r9 = 10;	 Catch:{ MCSException -> 0x0093 }
        r12 = java.lang.Math.min(r9, r12);	 Catch:{ MCSException -> 0x0093 }
        if (r12 <= 0) goto L_0x023c;
    L_0x020c:
        r6 = new java.lang.StringBuilder;	 Catch:{ MCSException -> 0x0093 }
        r6.<init>();	 Catch:{ MCSException -> 0x0093 }
        r4 = "Previous ";	 Catch:{ MCSException -> 0x0093 }
        r6 = r6.append(r4);	 Catch:{ MCSException -> 0x0093 }
        r6 = r6.append(r12);	 Catch:{ MCSException -> 0x0093 }
        r4 = " bytes";	 Catch:{ MCSException -> 0x0093 }
        r6 = r6.append(r4);	 Catch:{ MCSException -> 0x0093 }
    ...
    L_0x0230:
        ...
        r0 = r19;
        r15 = r0.m_readPos;
        r15 = r15 - r12;	 Catch:{ MCSException -> 0x0093 }
        com.abaltatech.mcs.utils.ByteUtils.dumpBuffer(r10, r15, r12);	 Catch:{ MCSException -> 0x0093 }
    L_0x023c:
        r0 = r19;
        r12 = r0.m_bufferSize;
        r0 = r19;
    ...
    L_0x0257:
        ...
        goto L_0x0254;
    L_0x025d:
        com.abaltatech.mcs.common.MemoryPool.freeMem(r3);	 Catch:{ MCSException -> 0x0093 }
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.abaltatech.mcs.mtp.MTPLayer.onDataReceived(com.abaltatech.mcs.common.IMCSDataLayer):void");
    }
    ...
    public void closeConnection(IMCSDataLayer $r1) throws MCSException {
        if ($r1 instanceof ConnectionPointMTP) {
            ...
            synchronized (this.m_connections) {
                $z0 = this.m_connections.remove($r3);
            }
            if ($z0) {
                notifyForConnectionClosed($r3, $r3.getFromAddress(), $r3.getToAddress());
                $r3.closeConnection();
    ...
    public IMCSDataLayer createConnectionPoint(IMCSConnectionAddress $r1, IMCSConnectionAddress $r2) throws MCSException {
        ...
        ConnectionPointMTP $r3;
        synchronized (this.m_connections) {
            Iterator $r7 = this.m_connections.iterator();
            while ($r7.hasNext()) {
                $r3 = (ConnectionPointMTP) $r7.next();
                IMCSConnectionAddress $r9 = $r3.getFromAddress();
                IMCSConnectionAddress $r10 = $r3.getToAddress();
                if ($r1.isSameAs($r9) && $r2.isSameAs($r10)) {
                    throw new MCSException("MTP Connection point already exists!");
                }
            }
            $r3 = new ConnectionPointMTP(this.m_dataLayer, $r1, $r2, this);
        ...
        if (!$assertionsDisabled && ($r3 == null || $r4 == null)) {
            ...
            if ($r10 != null) {
                ...
                if (!$assertionsDisabled && $r11 == null) {
                    ...
                    $r10.OnConnectionEstablished($r3, $r4, $r11);
    ...
    public int getConnectionPointCount() throws  {
