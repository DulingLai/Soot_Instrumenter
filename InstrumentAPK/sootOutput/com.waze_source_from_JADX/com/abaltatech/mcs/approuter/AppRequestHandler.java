...
class AppRequestHandler implements IRequestHandler {
    ...
    public com.abaltatech.mcs.approuter.MsgInfo getMessage() throws  {
        /*
        r10 = this;
        r0 = r10.m_app;
        monitor-enter(r0);
    ...
    L_0x0017:
        ...
        com.abaltatech.mcs.logger.MCSLogger.log(r7, r6);	 Catch:{ Throwable -> 0x0024 }
    L_0x0021:
        monitor-exit(r0);	 Catch:{ Throwable -> 0x0024 }
        r8 = 0;
        return r8;
    L_0x0024:
        ...
        throw r9;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.abaltatech.mcs.approuter.AppRequestHandler.getMessage():com.abaltatech.mcs.approuter.MsgInfo");
    }
}
