...
public class RegisterNotificationCommand extends WLServiceCommand {
    ...
    public RegisterNotificationCommand(DataBuffer $r1) throws  {
        super($r1);
        if (!isValid()) {
            Log.e("RegisterNotificationCommand", "Not a valid command!");
        }
        short $s0 = getCommandID();
        if ($s0 != ID) {
            Log.e("RegisterNotificationCommand", "Invalid command ID: " + $s0);
        }
    }

    public RegisterNotificationCommand(String $r1, String $r2, int $i0, byte[] $r3, int $i1) throws  {
        ...
        if (super.isValid()) {
            ...
            this.m_registerNotificationID = $i1;
        }
    }
    ...
    public boolean isValid() throws  {
        ...
        if ($z0) {
            ...
            this.m_registerNotificationID = this.m_binaryCommandContainer.getInt($i0 + 4);
