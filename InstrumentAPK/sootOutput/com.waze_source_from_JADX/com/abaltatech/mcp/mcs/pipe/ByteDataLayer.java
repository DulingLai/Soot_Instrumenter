package com.abaltatech.mcp.mcs.pipe;
...
public class ByteDataLayer extends MCSDataLayerBase {
    ...
    L_0x001c:
        r7 = new com.abaltatech.mcp.mcs.common.MCSException;	 Catch:{ MCSException -> 0x0024 }
    ...
    L_0x0024:
        ...
        r8 = "ERROR";
        com.abaltatech.mcp.mcs.logger.MCSLogger.log(r8, r9);	 Catch:{ Throwable -> 0x0042 }
        if (r3 == 0) goto L_0x0035;
    L_0x0030:
        r8 = "ConnectionPointMTP";
        com.abaltatech.mcp.mcs.common.MemoryPool.freeMem(r3, r8);	 Catch:{ Throwable -> 0x0042 }
    L_0x0035:
        monitor-exit(r12);	 Catch:{ Throwable -> 0x0042 }
        r2 = 0;
        return r2;
    L_0x0038:
        ...
        com.abaltatech.mcp.mcs.common.MemoryPool.freeMem(r4);	 Catch:{ MCSException -> 0x0024 }
        monitor-exit(r12);	 Catch:{ Throwable -> 0x0042 }
        return r6;
    L_0x0042:
        r11 = move-exception;
        ...
        throw r11;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.abaltatech.mcp.mcs.pipe.ByteDataLayer.readData(byte[], int):int");
    }
