...
public class SSLSocketLayer extends SocketTransportLayer {
    ...
    L_0x000d:
        r4 = "";
        r5 = "Too small buffer";
        com.abaltatech.mcp.mcs.logger.MCSLogger.log(r4, r5);	 Catch:{ Throwable -> 0x0026 }
    ...
    L_0x0029:
        ...
        return r11;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.abaltatech.mcp.mcs.sockettransport.SSLSocketLayer.readData(byte[], int):int");
    }
}
