...
public class TCPIPPacketPool {
    ...
    public static com.abaltatech.mcp.mcs.tcpip.TCPIPPacket getPacket(java.lang.String r9) throws com.abaltatech.mcp.mcs.common.MCSException {
        /*
        r0 = m_freePackets;
        monitor-enter(r0);
    ...
    L_0x0021:
        ...
        com.abaltatech.mcp.mcs.logger.MCSLogger.log(r6, r9);	 Catch:{ Throwable -> 0x0054 }
    L_0x0049:
        monitor-exit(r0);	 Catch:{ Throwable -> 0x0054 }
        return r4;
    L_0x004b:
        monitor-exit(r0);	 Catch:{ Throwable -> 0x0054 }
        r7 = new com.abaltatech.mcp.mcs.common.MCSException;
    ...
    L_0x0054:
        ...
        throw r8;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.abaltatech.mcp.mcs.tcpip.TCPIPPacketPool.getPacket(java.lang.String):com.abaltatech.mcp.mcs.tcpip.TCPIPPacket");
    }
