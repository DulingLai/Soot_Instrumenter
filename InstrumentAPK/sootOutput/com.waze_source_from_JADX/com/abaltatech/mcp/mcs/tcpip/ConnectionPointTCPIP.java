...
import com.abaltatech.mcp.mcs.utils.DataQueueInt;
...
public class ConnectionPointTCPIP extends MCSDataLayerBase implements Runnable {
    ...
    public boolean isIPPacketForMe(com.abaltatech.mcp.mcs.tcpip.TCPIPPacket r13) throws  {
        /*
        r12 = this;
        monitor-enter(r12);
    ...
    L_0x0008:
        ...
        r4 = com.abaltatech.mcp.mcs.tcpip.TCPIPAddressPool.getAddress(r2, r3);	 Catch:{ Exception -> 0x003a }
        r2 = r13.getDestIPAddress();	 Catch:{ Exception -> 0x003a }
        r3 = r13.getDestPort();	 Catch:{ Exception -> 0x003a }
        r5 = com.abaltatech.mcp.mcs.tcpip.TCPIPAddressPool.getAddress(r2, r3);	 Catch:{ Exception -> 0x003a }
    ...
    L_0x0032:
        r0 = 1;
    L_0x0033:
        com.abaltatech.mcp.mcs.tcpip.TCPIPAddressPool.freeAddress(r4);	 Catch:{ Exception -> 0x003a }
        com.abaltatech.mcp.mcs.tcpip.TCPIPAddressPool.freeAddress(r5);	 Catch:{ Exception -> 0x003a }
        return r0;
    L_0x003a:
        r8 = move-exception;
        r9 = r8.toString();
        r10 = "ERROR";
        com.abaltatech.mcp.mcs.logger.MCSLogger.log(r10, r9);
        return r0;
    L_0x0045:
        r11 = move-exception;
        monitor-exit(r12);	 Catch:{ Throwable -> 0x0045 }
    ...
    L_0x0048:
        ...
        goto L_0x0033;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.abaltatech.mcp.mcs.tcpip.ConnectionPointTCPIP.isIPPacketForMe(com.abaltatech.mcp.mcs.tcpip.TCPIPPacket):boolean");
    }
    ...
    L_0x0020:
        r7 = new com.abaltatech.mcp.mcs.common.MCSException;	 Catch:{ MCSException -> 0x0028 }
    ...
    L_0x0028:
        ...
        r8 = "ERROR";
        com.abaltatech.mcp.mcs.logger.MCSLogger.log(r8, r9);	 Catch:{ Throwable -> 0x005a }
        if (r3 == 0) goto L_0x0039;
    L_0x0034:
        r8 = "MTPLayer";
        com.abaltatech.mcp.mcs.common.MemoryPool.freeMem(r3, r8);	 Catch:{ Throwable -> 0x005a }
    L_0x0039:
        monitor-exit(r13);	 Catch:{ Throwable -> 0x005a }
        r2 = 0;
        return r2;
    L_0x003c:
        ...
        com.abaltatech.mcp.mcs.common.MemoryPool.freeMem(r4);	 Catch:{ MCSException -> 0x0028 }
        r3 = 0;
    ...
    L_0x005a:
        ...
        throw r12;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.abaltatech.mcp.mcs.tcpip.ConnectionPointTCPIP.readData(byte[], int):int");
    }
    ...
    L_0x001c:
        ...
        com.abaltatech.mcp.mcs.logger.MCSLogger.log(r7, r6);	 Catch:{ Throwable -> 0x0012 }
    ...
    L_0x002a:
        ...
        goto L_0x0005;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.abaltatech.mcp.mcs.tcpip.ConnectionPointTCPIP.run():void");
    }
    ...
    L_0x0012:
        ...
        com.abaltatech.mcp.mcs.common.MemoryPool.freeMem(r3);	 Catch:{ MCSException -> 0x001c }
        goto L_0x000a;
    L_0x001c:
        r4 = move-exception;
    ...
    L_0x0034:
        ...
        r7 = com.abaltatech.mcp.mcs.tcpip.TCPIPPacketPool.getPacket(r8);	 Catch:{ MCSException -> 0x0077 }
        ...
        com.abaltatech.mcp.mcs.tcpip.TCPIPPacketPool.freePacket(r7);	 Catch:{ MCSException -> 0x0077 }
        r9 = r15.m_fromAddress;	 Catch:{ MCSException -> 0x0077 }
        com.abaltatech.mcp.mcs.tcpip.TCPIPAddressPool.freeAddress(r9);	 Catch:{ MCSException -> 0x0077 }
        r9 = r15.m_toAddress;	 Catch:{ MCSException -> 0x0077 }
        com.abaltatech.mcp.mcs.tcpip.TCPIPAddressPool.freeAddress(r9);	 Catch:{ MCSException -> 0x0077 }
        return;
    L_0x0077:
        ...
        r14 = r13.toString();
        r8 = "ERROR";
        com.abaltatech.mcp.mcs.logger.MCSLogger.log(r8, r14);
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.abaltatech.mcp.mcs.tcpip.ConnectionPointTCPIP.closeConnection():void");
    }
