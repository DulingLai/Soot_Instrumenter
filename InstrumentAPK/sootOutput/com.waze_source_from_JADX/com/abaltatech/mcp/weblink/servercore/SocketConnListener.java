...
import com.abaltatech.mcp.mcs.gateway.ListenConnectionHandler;
...
*/
            ...
            r0 = r17;
            r5 = com.abaltatech.mcp.weblink.servercore.SocketConnListener.this;
        ...
        L_0x0020:
            r0 = r17;	 Catch:{ Exception -> 0x0052 }
            r5 = com.abaltatech.mcp.weblink.servercore.SocketConnListener.this;	 Catch:{ Exception -> 0x0052 }
        ...
        L_0x0028:
            ...
            r2 = r5.m_serverName;
            r0 = r17;	 Catch:{ InterruptedException -> 0x003f }
            r5 = com.abaltatech.mcp.weblink.servercore.SocketConnListener.this;	 Catch:{ InterruptedException -> 0x003f }
        ...
        L_0x0047:
            ...
            com.abaltatech.mcp.mcs.logger.MCSLogger.log(r14, r9);	 Catch:{ InterruptedException -> 0x003f }
            goto L_0x0039;
        L_0x0052:
            r15 = move-exception;
            r1 = r4;
        L_0x0054:
            ...
            com.abaltatech.mcp.mcs.logger.MCSLogger.log(r14, r2);
            goto L_0x0041;
        L_0x005e:
            r1 = r4;
            goto L_0x0041;
        ...
        L_0x0064:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: com.abaltatech.mcp.weblink.servercore.SocketConnListener.1.run():void");
        }
    ...
    public synchronized void OnConnectionEstablished(IMCSConnectionAddress $r1, IMCSConnectionAddress $r2, IMCSDataLayer $r3, IMCSMultiPointLayer $r4) throws  {
        if ($assertionsDisabled || this.m_receiver != null) {
            ...
            this.m_receiver.OnConnectionEstablished($r1, $r2, $r3, $r4);
        } else {
    ...
    protected void StartNetworkBroadcasting() throws  {
        if (this.m_isBroadcastingEnabled && this.m_serverName != null && this.m_broadcastPort > 0 && this.m_listenAddress != null && (this.m_listenAddress instanceof TCPIPAddress)) {
            this.m_broadcastThread = new C03821();
