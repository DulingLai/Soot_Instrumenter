...
import com.abaltatech.mcp.weblink.core.WebLinkConnection;
import com.abaltatech.mcp.weblink.core.commandhandling.Command;
import com.abaltatech.mcp.weblink.core.commandhandling.FillRectangleCommand;
import com.abaltatech.mcp.weblink.core.commandhandling.ICommandHandler;
import com.abaltatech.mcp.weblink.core.commandhandling.VideoConfigCommand;
import com.abaltatech.mcp.weblink.core.frameencoding.IFrameEncodedHandler;
import com.abaltatech.mcp.weblink.core.frameencoding.IFrameEncoder;
...
public abstract class WebLinkServerConnection implements IMCSConnectionClosedNotification, ICommandHandler, IFrameEncodedHandler {
    ...
    protected void configureVideoEncoder(com.abaltatech.mcp.weblink.core.commandhandling.VideoConfigCommand r1) throws  {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.abaltatech.mcp.weblink.servercore.WebLinkServerConnection.configureVideoEncoder(com.abaltatech.mcp.weblink.core.commandhandling.VideoConfigCommand):void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.abaltatech.mcp.weblink.servercore.WebLinkServerConnection.configureVideoEncoder(com.abaltatech.mcp.weblink.core.commandhandling.VideoConfigCommand):void");
    }
    ...
    public void onFrameEncoded(int width, int height, int frameEncoding, ByteBuffer $r1) throws  {
        synchronized (this) {
            if (this.m_connection != null) {
                if (this.m_frameEncoder != null && this.m_frameEncoder.canDiscardFrames()) {
                    this.m_connection.removeCommandsWithID(1);
                }
