...
public class Command {
    ...
    public static final byte MAGIC_BYTE1 = (byte) 87;
    public static final byte MAGIC_BYTE2 = (byte) 76;
    ...
    public static final boolean isValidCommand(DataBuffer $r0) throws  {
        ...
        return $r0.getByte(0) == MAGIC_BYTE1 && $r0.getByte(1) == MAGIC_BYTE2 && $r0.getInt(4) == $r0.getSize() - 8;
    }
    ...
    public static int findValidCommand(byte[] $r0, int $i0, int $i1) throws  {
        ...
        while ($i1 >= 8 && ($r0[$i0] != MAGIC_BYTE1 || $r0[$i0 + 1] != MAGIC_BYTE2)) {
            $i0++;
            $i1--;
        }
        return $i1 >= 8 ? $i0 : -1;
