...
public class FrameEncoderFactory {
    ...
    public void registerEncoder(@Signature({"(I", "Ljava/lang/Class", "<+", "Lcom/abaltatech/mcp/weblink/core/frameencoding/IFrameEncoder;", ">;)V"}) int $i0, @Signature({"(I", "Ljava/lang/Class", "<+", "Lcom/abaltatech/mcp/weblink/core/frameencoding/IFrameEncoder;", ">;)V"}) Class<? extends IFrameEncoder> $r1) throws  {
